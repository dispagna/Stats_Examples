...
$$p(y_i;N, n_i, k_{i-1}) = \frac{\binom{k_i}{y_i}\binom{N-k_{i-1}}}{n_i-y_i}}{\binom{N}{n_i}}$$
...
Given these assumptions, then the likelihood for _y_ bugs found by both test teams is given by...
