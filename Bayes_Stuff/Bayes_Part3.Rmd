...
# Fit model
mdl_gam <- stan(model_code=mdl_code, data=mdl_data)
```
...
Finally, I'll check the posterior predictive distribution, and compare it to the loess.  
...
# Method 2: Calculate 89% interval for expected value of posterior predictive
...
p2 <- ggplot(mapping=aes(x=disp, y=mpg),
              data=mtcars) +
  geom_point(aes(color=factor(cyl)))+
