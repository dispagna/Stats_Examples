...
I follow the example in this [vignette](https://github.com/milkha/Splines_in_Stan/blob/master/splines_in_stan.pdf) for fitting a semi-parametric model with _rstan_. First, I'll define the splines just as I did when using the _rethinking_ package.  
